...
// Lazy load RemediesDashboard for performance optimization
const RemediesDashboard = dynamic(() => import('../../../components/dashboard/remedies'), {
  loading: () => (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
      <div className="h-8 w-8 animate-spin rounded-full border-2 border-[#D4AF37] border-t-transparent" />
      <p className="text-sm text-[#B8BCC8]">Generating traditional remedies…</p>
    </div>
  ),
  ssr: false,
});
...
export default function RemediesPage() {
  ...
  return <RemediesDashboard chart={chart} />;
}
    ...
    <div className="px-6 py-8 lg:px-10">
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-white/50">Generate your birth chart first to view remedies.</p>
        </div>
        <Link
          href="/birth-form"
